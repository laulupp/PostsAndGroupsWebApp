<div class="w3-container w3-border w3-border-blue w3-pale-blue w3-round-large w3-col s10 m6 l4 w3-display-middle" style="border-width: 3px !important;">
     <form class="w3-container w3-margin" method="POST" action="/auth.php?page=login">
    ...
    <div class="w3-center w3-margin">
        <a onclick="location.href='/auth.php?page=register'" style="cursor:pointer;" class="w3-text-blue w3-hover-text-gray"><b>Register here if you don't have an account</b></a>
    </div>
</div>
