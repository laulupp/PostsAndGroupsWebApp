...
function dbConnect($dbC){
        ...
        if($connection){
            ...
            pg_query("CREATE TABLE IF NOT EXISTS ".$dbC->db_schema.".".$dbC->db_postsTable."( id SERIAL primary key, owner Varchar(255) not null, title Varchar(255) not null, shortdescription Varchar(255) not null, longdescription Varchar(5000), datecreated DATETIME NOT NULL DEFAULT now())");
            return true;
        }
